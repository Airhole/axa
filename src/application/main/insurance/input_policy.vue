<!--********************************************************************
 * Author        : xangzhi
 * Filename      : input_policy.vue
 * Description   : 在线投保-投保书预览-录入投保单号
 * Time          : 2017/10/24
 *
********************************************************************-->
<template>
  <div class="page_applicant_input_policy">
    <div class="form">
      <form-unit
